    ...
    <div>
      ...
      <div className="mt-12 px-40 flex flex-col gap-y-8">
        <div
          className={
            accordion === 1
              ? 'w-full h-48 border-2 rounded-xl transition-all duration-300'
              : 'w-full h-16 border-2 rounded-xl transition-all duration-300'
          }
        ...
        >
          ...
          {accordion === 1 && (
            <div className="py-4 px-6 text-md font-Yek-Light">
              <div className="border-t-2 text-justify">
                <span>
