        ...
        <div className="shadow-sm bg-white h-auto rounded-xl p-9 flex gap-x-9">
          ...
          <div>
            ...
            <div className="mt-4 flex items-center justify-between">
              <div>
                <button className="flex items-center gap-x-3 bg-primary-300 p-3 text-white font-Yek-ExtraBold rounded-xl text-lg hover:ring-[7px] transition-all duration-300">
        ...
        <div>
          ...
          >
            <div className="flex items-center gap-x-2">
              <p className="w-2 h-2 bg-primary-300 rounded-full"></p>
              <h1 className="text-2xl font-Yek-ExtraBlack text-primary-300">
                توضیحات
              </h1>
            </div>
            <div className="mt-4">
            ...
            <div className="my-4">
              {openSection ? (
                <button
                  className="bg-primary-300 z-10 absolute bottom-1 right-[350px] p-2 rounded-xl text-md font-Yek-ExtraBold hover:ring-[4px] transition-all duration-300 text-white"
              ...
              <form>
                <div className="flex flex-col">
                  ...
                  <textarea
                    ...
                    className="w-[780px] h-48 bg-gray-100 outline-none resize-none p-2 rounded-xl text-gray-800 font-Yek-Regular"
                  ></textarea>
                </div>
                <div className="mt-4 flex items-center justify-end">
                  <button className="text-lg font-Yek-ExtraBold text-white bg-primary-300 p-3 rounded-xl transition-all duration-300 hover:ring-[6px]">
                    ارسال کامنت
                  </button>
                </div>
              </form>
