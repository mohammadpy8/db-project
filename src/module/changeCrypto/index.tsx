...
const ChangeCrypto: FC = () => {
  ...
  return (
    <div className="mt-12 mr-8 group">
      ...
      <div className="w-[400px] h-[430px]  bg-white rounded-lg shadow-lg absolute top-[245px] left-[190px] group-hover:scale-105 transition-all duration-300 group-hover:opacity-100">
